...
struct ArMaOption {
  ...
  void save(std::ofstream& file) {
    ...
    file.write(reinterpret_cast<char*>(&beta1), sizeof(beta1));
    file.write(reinterpret_cast<char*>(&beta2), sizeof(beta2));
    ...
    file.write(reinterpret_cast<char*>(&nIter), sizeof(nIter));
    m.save(file);
    v.save(file);
  }
